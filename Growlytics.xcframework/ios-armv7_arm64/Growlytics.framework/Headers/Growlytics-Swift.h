...
@interface APNSMessagingService (SWIFT_EXTENSION(Growlytics)) <UNUserNotificationCenterDelegate>
...
SWIFT_CLASS("_TtC10Growlytics23GrwNotificationConstant")
@interface GrwNotificationConstant : NSObject
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end
